...
public class NewQuiz implements TestFactory{
	 ...
	 */
	public boolean startTest(WordList currentList) {
		// TODO Auto-generated method stub
		if (!getTestedWords(currentList,_level)){
			JOptionPane.showMessageDialog(null, "Invalid list Level! One or more levels do not"
					+ "\ncontain at least 10 words. Pls upload correct list.", "Invalid List", JOptionPane.ERROR_MESSAGE);
			return false;
		} 
